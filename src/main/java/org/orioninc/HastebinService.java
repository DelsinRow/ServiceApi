...
public class HastebinService {
    ...
    String allQuestions = QuestionsOutput.Questions(StackOverflowService.questionsList);
    ...
    public void submitDocument(HttpClient client) throws IOException, InterruptedException {
